...
<details>
  ...
  - `git clone git@github.com:tryber/sd-016-b-mongodb-commerce.git`.

  - Entre na pasta do repositório que você acabou de clonar:
    - `cd sd-016-b-mongodb-commerce`
  ...
  - Usando o exemplo anterior: `git push -u origin joaozinho-sd-016-b-mongodb-commerce`

  6. Crie um novo `Pull Request` _(PR)_

  - Vá até a página de _Pull Requests_ do [repositório no GitHub](https://github.com/tryber/sd-016-b-mongodb-commerce/pulls)
  ...
  - Volte até a [página de _Pull Requests_ do repositório](https://github.com/tryber/sd-016-b-mongodb-commerce/pulls) e confira se o seu _Pull Request_ está criado
